                ...
                <div class="intro-slider owl-carousel owl-theme owl-nav-inside owl-light" data-toggle="owl" data-owl-options='{"nav": false, "dots": false}'>
                    <div class="intro-slide" style="background-image: url(<?= base_url('assets/'); ?>assets/images/demos/demo-2/slider/slide-1.jpg);">
                        <div class="container intro-content text-center">
                            <h3 class="intro-subtitle text-white">Shop</h3><!-- End .h3 intro-subtitle -->
                            <h1 class="intro-title text-white">GoniCraft</h1><!-- End .intro-title -->
                            <div class="intro-text text-white">Let's go</div><!-- End .intro-text -->
