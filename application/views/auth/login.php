    ...
    <div id="content">
      <div class="header">
        <div class="header-inner">
          ...
          <a class="navbar-brand center-block" href="<?= base_url()?>" title="Home">
            <h1 class="hidden">
                <img src="<?= base_url('assets/'); ?>img/logo.png" alt="Flexor Logo">
                CraftGoni
              </h1>
          </a>
        </div>
        ...
        <div class="col-sm-6 col-sm-offset-3">
          <div class="panel panel-default">
            ...
            <?php
                ...
                ?>
              <form accept-charset="UTF-8" role="form" action="<?= base_url('index.php/auth/action_login');?>" method="post">
                <fieldset>
