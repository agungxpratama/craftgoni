          ...
          <div class="row">
            <div class="col-md-8">
              ...
              <a class="navbar-brand" href="index.html" title="Home">
                <h1 class="hidden">
                    <img src="<?= base_url('Flexor/')?>img/logo.png" alt="Flexor Logo">
                    CraftGoni
                  </h1>
              </a>
              ...
              <!-- <ul class="list-inline user-menu pull-right">
                ...
                <?php
                    if (!$this->session->has_userdata('status')) {
                       ?>
                       <ul class="list-inline user-menu pull-right">
                            <li class="user-register"><i class="fa fa-edit text-primary "></i> <a href="<?= base_url()?>index.php/auth/register" class="text-uppercase">Register</a></li>
                            <li class="user-login"><i class="fa fa-sign-in text-primary"></i> <a href="<?= base_url()?>index.php/auth" class="text-uppercase">Login</a></li>
                        </ul>
                       <?php
                    }else{
                        ?>
                       <ul class="list-inline user-menu pull-right">
                            <li class="user-register"><i class="fa fa-edit text-primary "></i> <a href="<?= base_url()?>index.php/auth/logout" class="text-uppercase">Logout</a></li>
                        </ul>
                       <?php
                    }
                ?>
              ...
              <div class="row">
                <div class="col-md-6 col-md-push-6 item-caption">
                  <h2 class="h1 text-weight-light">
                      Welcome to <span class="text-primary">CraftGoni</span>
                    </h2>
                  <h4>
